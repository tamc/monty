...
#    charts['fuel_cost'] = new slider(tag:"#fuel",x_axis_title:"Fuel cost (£/MWh)", property: (d) -> d.fuel_cost)
  ...
  charts['energy_delivered'] = new slider(tag: "#energyDelivered", x_axis_title: "Energy delivered TWh", x_max:70, width: 500, height: 250,  property: (d) -> d.energyDelivered)
  charts['public_spend'] = new slider(tag: "#publicSpend", x_axis_title: "Public expenditure £bn", x_max: 7, width: 500, height: 250, property: (d) -> d.publicSpend)
